...
[.allSatisfy()](https://www.codecademy.com/resources/docs/swift/arrays/allSatisfy)

Returns a boolean expression indicating whether every element of a sequence satisfies a given condition.

[.append()](https://www.codecademy.com/resources/docs/swift/arrays/append)

Adds an element to the end of an array.

[.contains()](https://www.codecademy.com/resources/docs/swift/arrays/contains)

Returns true if an array contains a specified element, false otherwise.

[.count](https://www.codecademy.com/resources/docs/swift/arrays/count)

Returns the number of elements in an array.

[.filter()](https://www.codecademy.com/resources/docs/swift/arrays/filter)

Returns a new array with only the elements that meet the condition stated in the filter.

[.first()](https://www.codecademy.com/resources/docs/swift/arrays/first)

Returns the first element of the array that satisfies the given condition.

[.firstIndex()](https://www.codecademy.com/resources/docs/swift/arrays/firstIndex)

Returns the index of the first element in an array that satisfies the given condition.

[.forEach()](https://www.codecademy.com/resources/docs/swift/arrays/forEach)

Loops over an array and performs some action on each element within it.

[.insert()](https://www.codecademy.com/resources/docs/swift/arrays/insert)

Adds an element to a desired position of an array.

[.isEmpty](https://www.codecademy.com/resources/docs/swift/arrays/isEmpty)

Returns true if an array contains no elements, returns false if the array contains one or more elements.

[.map()](https://www.codecademy.com/resources/docs/swift/arrays/map)

Returns a new array with the results of calling a function for every element in the array.

[.randomElement()](https://www.codecademy.com/resources/docs/swift/arrays/randomElement)

Returns a random element from an array.

[.reduce()](https://www.codecademy.com/resources/docs/swift/arrays/reduce)
...
[.remove()](https://www.codecademy.com/resources/docs/swift/arrays/remove)

Removes an element from an array at a specified index.

[.removeFirst()](https://www.codecademy.com/resources/docs/swift/arrays/removeFirst)

Removes the first element in an array.

[.removeLast()](https://www.codecademy.com/resources/docs/swift/arrays/removeLast)

Removes the last element in an array.

[.reverse()](https://www.codecademy.com/resources/docs/swift/arrays/reverse)

Reverses the elements within an array so that the first element becomes the last element and vice versa.

[.shuffle()](https://www.codecademy.com/resources/docs/swift/arrays/shuffle)

Randomly shuffles the elements of an array.

[.sort()](https://www.codecademy.com/resources/docs/swift/arrays/sort)

Sorts elements of any mutable collection in ascending order.

[Capacity](https://www.codecademy.com/resources/docs/swift/arrays/capacity)

Returns the total number of elements that the array can contain without allocating new storage.

[dropFirst()](https://www.codecademy.com/resources/docs/swift/arrays/dropFirst)

Returns a subsequence by skipping the first element or first n elements from a Swift collection.
